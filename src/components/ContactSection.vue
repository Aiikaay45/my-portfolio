<template>
    <section class="text-white mt-20" id="contact">
        ...
        <div class="grid md:grid-cols-2 gap-4 relative px-4 xl:px-16 mt-8" data-aos="zoom-in-up">
            <div>
                <p class="text-[#adb7be]">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Eius quasi qui
                    dolores ea placeat! Asperiores cupiditate excepturi
                    aliquam impedit debitis facilis modi cumque blanditiis exercitationem necessitatibus veniam
                    suscipit, vero quos.
                </p>
            ...
            <form class="flex flex-col p-2" data-aos="zoom-in-up">
                <div class="mb-6">
                    ...
                    <input type="email" name="email" id="email" class="bg-[#111827] placeholder:text-[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-2.5"
                    placeholder="email@gmail.com">
                </div>
                <div class="mb-6">
                    <label for="subject" class="text-white block mb-2 text-sm font-medium">Subject</label>
                    <input type="text" name="subject" id="subject" class="bg-[#111827] placeholder:text-[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-2.5"
                    placeholder="subject">
                </div>
                <div class="mb-6">
                    <label for="message" class="text-white block mb-2 text-sm font-medium">Message</label>
                    <textarea id="message" name="message"  class="bg-[#111827] placeholder:text-[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-2.5"
                    placeholder="Let's talk about ..."></textarea>
                </div>
                <button class="z-1 !w-full px-6 md:px-7 py-3 rounded-full sm:w-max flex justify-center text-white bg-orange-400 border-2 border-transparent">
                    Send Message
                </button>
            </form>
        </div>
        </div>   
       <div class="bg-gradient-to-tr opacity-25 from-[#570cac] bg-orange-400 blur-2xl h-20 w-80 z-0 absolute -top-1/2 -left-4 transform -translate-x-2/3
       -translate-1/2
       "> </div>
    </section>
</template>
